...
const SourceGround = memo(function SourceGround(props) {
  ...
  return <div id="sourceground">
      <Search placeholder="搜索关键字(不区分大小写)" allowClear onSearch={onSearch} style={{
      width: 300
    }} />
      ...
      <Tabs defaultActiveKey='bgm' animated={false} destroyInactiveTabPane={false} items={items} onChange={() => {
      Howler.stop();
    }} />
    </div>;
});
